...
EASYRPG_TOOLCHAIN_DIR = $(CORE_DIR)/builds/libretro/jni/android_$(TARGET_ARCH_ABI)/libretro

# z
include $(CLEAR_VARS)
LOCAL_MODULE := z
LOCAL_SRC_FILES := $(EASYRPG_TOOLCHAIN_DIR)/lib/libz.a
...
LOCAL_EXPORT_C_INCLUDES := $(EASYRPG_TOOLCHAIN_DIR)/include
LOCAL_SRC_FILES := $(EASYRPG_TOOLCHAIN_DIR)/lib/libsamplerate.a
include $(PREBUILT_STATIC_LIBRARY)
...
# easyrpg player
include $(CLEAR_VARS)
LOCAL_MODULE := easyrpg_libretro
LOCAL_EXPORT_C_INCLUDES := $(CORE_DIR)/src
LOCAL_SRC_FILES := $(EASYRPG_TOOLCHAIN_DIR)/lib/easyrpg_libretro.a
include $(PREBUILT_STATIC_LIBRARY)
